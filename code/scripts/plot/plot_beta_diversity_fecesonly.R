...
###Step8.Save outputs
ggsave(
  file.path(dir_fig, "pcoa_global_genus_fecesonly.pdf"),
  p_pcoa_global,
  width = 8,
  height = 6,
  dpi = 300
...
ggsave(
  file.path(dir_fig, "permanova_barplot_genus_fecesonly.pdf"),
  p_permanova,
  width = 4,
  height = 6,
  dpi = 300
...
write.csv(
  perma_table,
  file.path(dir_tab, "permanova_table_genus_fecesonly.csv"),
  row.names = FALSE
)

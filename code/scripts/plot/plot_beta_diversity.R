...
ggsave(
  filename = file.path(dir_fig, "pcoa_global_genus.pdf"),
  plot = p_pcoa_global,
  width = 8,
  height = 6,
  dpi = 300
...
ggsave(
  filename = file.path(dir_fig, "permanova_barplot_genus.pdf"),
  plot = p_permanova,
  width = 4,
  height = 6,
  dpi = 300
...
write.csv(
  perma_table,
  file = file.path(dir_tab, "permanova_table_genus.csv"),
  row.names = FALSE
)
